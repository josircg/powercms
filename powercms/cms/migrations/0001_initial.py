...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dtcriacao', models.DateTimeField(auto_now_add=True, verbose_name='Dt. de criação')),
                ('backup', models.FileField(blank=True, null=True, upload_to=cms.models.backup_upload_to, verbose_name='Backup')),
                ('status', models.CharField(choices=[('P', 'Processando...'), ('C', 'Concluído!'), ('E', 'Erro ao gerar backup!')], default='P', max_length=1, verbose_name='Status')),
            ],
        ),
        migrations.CreateModel(
            name='EmailAgendado',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('path', models.FilePathField(editable=False, max_length=256, path='/home/josir/bitbucket/powercms/powercms/media/uploads/themes', recursive=True)),
            ],
            options={
                'verbose_name': 'Temas',
