...
CKEDITOR_CONFIGS = {
    'default': {
        ...
        'contentsCss': [
            ...
            os.path.join(STATIC_URL, 'public/css/ckeditor_configs.css') if os.path.exists(
                os.path.join(STATIC_ROOT, 'public/css/ckeditor_configs.css')) else '',
        ],
        'stylesSet': 'my_styles:%s' % os.path.join(STATIC_URL, 'ckeditor_config/styles.js'),
        'stylesSet': 'my_styles2:%s' % os.path.join(STATIC_URL, 'public/js/ckeditor_configs.js') if os.path.exists(
            os.path.join(STATIC_ROOT, 'public/js/ckeditor_configs.js')) else '',
    },
}
